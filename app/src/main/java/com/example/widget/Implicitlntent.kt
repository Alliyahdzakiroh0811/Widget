...
import com.example.widget.databinding.ActivityImplicitlntentBinding
import com.example.widget.databinding.ActivityMainBinding


// Membuat variable binding
private lateinit var binding: ActivityImplicitlntentBinding
class Implicitlntent() : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        //instalasi binding
        binding = ActivityImplicitlntentBinding.inflate(layoutInflater)
